...
\begin{samepage}
\ea \judgewidth{} \label{ex4.3} Preamble\\*
  This is an example with a preamble.
\z
\end{samepage}
...
\begin{samepage}
\ea \judgewidth{} \label{ex4.5} Any nice description here
...
\begin{samepage}
\ea \judgewidth{whynot?} \label{ex4.6} Throwing in a preamble for good
measure
...
\begin{samepage}
\ea \judgewidth{???} \label{ex4.7} Here is a special case with a
preamble\\*
