...
\item
  ...
  \href{https://cysouw.github.io/readme.html}{HTML} or
  \href{https://cysouw.github.io/readme_gb4e.pdf}{Latex}.
\end{itemize}
...
\href{https://cysouw.github.io/readme.html\#ex4.7}{this link}). The id
in this example has a chapter number `4' because in the html conversion
I have set the option \texttt{addChapterNumber} to \texttt{true}. (Note:
when numbers restart the count in each chapter with the option
\texttt{restartAtChapter}, then the id is of the form
