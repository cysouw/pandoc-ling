...
\begin{exe} \judgewidth{} \label{ex:4.1} 
...
\begin{exe} \judgewidth{} \label{ex:4.3} 
  \ex Preamble
...
\begin{exe} \judgewidth{} \label{ex:4.4} 
  \ex 
  \begin{xlist}
...
\begin{exe} \judgewidth{} \label{ex:4.5} 
...
\begin{exe} \judgewidth{whynot?} \label{ex:4.6} 
...
\begin{exe} \judgewidth{???} \label{ex:4.7} 
...
\begin{exe} \judgewidth{} \label{ex:4.8} 
  \ex [] { 
       Dutch (Germanic)
...
\begin{exe} \judgewidth{} \label{ex:4.9} 
  \ex [] { 
       Dutch (Germanic)
...
\begin{exe} \judgewidth{:-)} \label{ex:4.10} 
...
\begin{exe} \judgewidth{} \label{ex:4.12} 
  \ex [] { \[\sum_{x=1}^{n}{x}=\frac{x^2-x}{2}\]\\
   }
\end{exe}
