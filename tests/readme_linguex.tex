...
\ex. \label{ex:4.5} Any nice description here
  \a. one example sentence.
  \b. two
  \b. three
...
\ex. \label{ex:4.6} Throwing in a preamble for good measure
...
\ex. \label{ex:4.7} Here is a special case with a preamble\\
...
\ex. \label{ex:4.10} Completely superfluous preamble, but it works
\ldots{}
  \a. Mixing single line examples with interlinear examples.
