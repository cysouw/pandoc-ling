...
\item
  ...
  or
  \href{https://gitcdn.link/repo/cysouw/pandoc-ling/main/tests/readme_gb4e.pdf}{Latex}.
\end{itemize}
...
\begin{samepage}
\ea \judgewidth{:–)} \label{ex:4.12} Completely superfluous preamble,
but it works \ldots{}
